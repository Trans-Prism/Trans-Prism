...
class FtmWikiManager {
  static Future<String> get localWikiPath async {
    ...
    return '${directory.path}/ftm_wiki_site';
  }
  ...
  static Future<void> initLocalWiki() async {
    ...
    if (!await flagFile.exists()) {
      ...
      // 1. 读取 Assets 里的 zip
      final byteData =
          await rootBundle.load('assets/wiki_data/ftm-wiki-site.zip');
    ...
    unawaited(WikiUpdateManager().checkAndPerformHotUpdate('ftm'));
  }
}
