...
class MtfWikiManager {
  ...
  static Future<void> initLocalWiki() async {
    ...
    if (!await flagFile.exists()) {
      ...
      // 1. 读取 Assets 里的 zip
      final byteData =
          await rootBundle.load('assets/wiki_data/mtf-wiki-site.zip');
    ...
    unawaited(WikiUpdateManager().checkAndPerformHotUpdate('mtf'));
  }
}
