...
class _MtfWikiScreenState extends State<MtfWikiScreen> {
  late final WebViewController _controller;
  bool _isLoading = true;
  bool _showMenuHint = false;
  HttpServer? _localServer;

  static const String _prefsWikiMenuHintDismissed = 'wiki_menu_hint_dismissed';
  ...
  Future<void> _initWikiWithHardcoreServer() async {
    ...
    _controller = WebViewController()
      ...
      ..loadRequest(Uri.parse('http://localhost:8080/zh-cn/docs/index.html'));
