...
class _RleWikiScreenState extends State<RleWikiScreen> {
  ...
  Future<void> _initWikiWithHardcoreServer() async {
    ...
    _controller = WebViewController()
      ...
      ..loadRequest(Uri.parse('http://localhost:8082/index.html'));
